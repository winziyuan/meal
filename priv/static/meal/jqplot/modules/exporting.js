...
(function() {
	...
	var g = Highcharts, y = g.Chart, z = g.addEvent, B = g.removeEvent, r = g.createElement, u = g.discardElement, t = g.css, s = g.merge, k = g.each, n = g.extend, C = Math.max, h = document, D = window, A = h.documentElement.ontouchstart !==
	void 0, v = g.getOptions();
	n(v.lang, {
	...
	n(y.prototype, {
		...
		print : function() {
			...
			if(!a.isPrinting)
				a.isPrinting = !0, k(f, function(a, b) {
					if(a.nodeType === 1)
		...
		addButton : function(a) {
			...
			var c = this, d = c.renderer, e = s(c.options.navigation.buttonOptions, a), f = e.onclick, g = e.menuItems, h = e.width, k = e.height, o, p, q, a = e.borderWidth, j = {
